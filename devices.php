 ...
 <!DOCTYPE html>
  ...
  <body>
    ...
    <table id="devices_table" class="table table-bordered table-hover">
      <?php
        require_once "config.php";
        $sql = "select name, d.createdby, TO_CHAR(d.creationdate, 'DD.MM.YYYY HH24:MI:SS') as creationdate, u.login as creator_login from devices d join users u on u.iduser = d.createdby where d.deleted = '0'";
