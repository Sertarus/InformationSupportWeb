...
?>
  ...
  $sql = "select name, d.createdby, TO_CHAR(d.creationdate, 'DD.MM.YYYY HH24:MI:SS') as creationdate, d.changedby, TO_CHAR(d.changeddate, 'DD.MM.YYYY HH24:MI:SS') as changeddate, u.login as createdbyname, us.login as changedbyname from devices d left join users u on u.iduser = d.createdby left join users us on us.iduser = d.changedby where name = :p1";
